...
const TIER_CONFIG = { free: { qrLimit: 100 }, essential: { qrLimit: 5000 }, scale: { qrLimit: 25000 }, enterprise: { qrLimit: 100000 } };
const PRICE_TO_TIER = { 'price_1SLwgr2Octf3b3PtKdeaw5kk': 'essential', 'price_1SLwkL2Octf3b3Pt29yFLCkI': 'scale', 'price_1SLwm82Octf3b3Pt09oWF4Jj': 'enterprise' };

// CRITICAL: DISABLE ALL PARSING
export const config = {
  api: {
    bodyParser: false,
